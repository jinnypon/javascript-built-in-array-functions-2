...
function calPaidByLocation(bills) {
  return bills.reduce(function (accumulatorObject, bill) {
    if (accumulatorObject[bill.location] === undefined) {
      accumulatorObject[bill.location] = bill.total;
    } else {
      accumulatorObject[bill.location] =
        accumulatorObject[bill.location] + bill.total;
    }
...
const totalPaidByLocation = calPaidByLocation(bills);
